...
posterior = infer(td_approx, prior, 'SNPE', num_simulations = num_simulations, num_workers=20)
...
plt.legend()
plt.savefig('/home/mrtodd/grav_test_results.png')
